...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/s/ju/dt-1.10.10,b-1.1.0,fc-3.2.0,r-2.0.0,sc-1.4.0/datatables.min.css">
        ...
        <div class="page-body">
            <div class="card card-block p-3">
                <div class="table-responsive ">
                    <table class="table table-bordered stripe row-border order-column" id="table_data_payroll">
                        <thead>
                            <tr>
...
{{--    <script src="https://cdn.datatables.net/fixedcolumns/3.2.6/js/dataTables.fixedColumns.min.js"></script>--}}
    ...
    <script type="text/javascript" src="{{ asset('table.js')}}"></script>
</html>
