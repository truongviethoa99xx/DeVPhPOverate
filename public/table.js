...
$jscomp.checkEs6ConformanceViaProxy = function() {
    try {
        var a = {},
            h = Object.create(new $jscomp.global.Proxy(a, {
                get: function(k, e, d) {
                    return k == a && "q" == e && d == h
                }
            }));
...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(a, h, k) {
...
$jscomp.polyfill = function(a, h, k, e) {
    h && ($jscomp.ISOLATE_POLYFILLS ? $jscomp.polyfillIsolated(a, h, k, e) : $jscomp.polyfillUnisolated(a, h, k, e))
};
$jscomp.polyfillUnisolated = function(a, h, k, e) {
    ...
    e = k[a];
    h = h(e);
    h != e && null != h && $jscomp.defineProperty(k, a, {
        configurable: !0,
        writable: !0,
        value: h
    })
...
$jscomp.polyfillIsolated = function(a, h, k, e) {
    ...
    h = h(k);
    null != h && (a ? $jscomp.defineProperty($jscomp.polyfills, d, {
        configurable: !0,
        writable: !0,
        value: h
    }) : h !== k && ($jscomp.propertyToPolyfillSymbol[d] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(d) : $jscomp.POLYFILL_PREFIX + d, d =
...
(function() {
    var a, h, k = function() {
        function e(d, g) {
            var m = this;
            if (!h || !h.versionCheck || !h.versionCheck("1.10.0")) throw Error("StateRestore requires DataTables 1.10 or newer");
            d = new h.Api(d);
            this.classes = a.extend(!0, {}, e.classes);
            this.c = a.extend(!0, {}, e.defaults, g);
            g && void 0 !== g.left || void 0 === this.c.leftColumns || (this.c.left = this.c.leftColumns);
            g && void 0 !== g.right || void 0 === this.c.rightColumns || (this.c.right = this.c.rightColumns);
            this.s = {
                barWidth: 0,
                dt: d,
            ...
            this.dom = {
                leftBottomBlocker: a("<div>").css(g).css("left", 0).addClass(this.classes.leftBottomBlocker),
                leftTopBlocker: a("<div>").css(g).css({
                    left: 0,
                    top: 0
                }).addClass(this.classes.leftTopBlocker),
                rightBottomBlocker: a("<div>").css(g).css("right", 0).addClass(this.classes.rightBottomBlocker),
                rightTopBlocker: a("<div>").css(g).css({
                    right: 0,
                    top: 0
        ...
        e.prototype._addStyles = function() {
            if (this.s.dt.settings()[0].oScroll.sY) {
                ...
                this.s.barWidth = d.offsetWidth - d.clientWidth >= g ? g : 0;
            ...
            var m = null;
            null !== g && (g = a(g), m = g.outerHeight() + 1, d = a(g.closest("div.dataTables_scroll")).css("position", "relative"));
            var n = this.s.dt.column(2).footer(),
                c = null;
            ...
            for (var b = this.s.dt.columns().data().toArray().length, f = 0, l = 0, u = a(this.s.dt.table().node()).children("tbody").children("tr"), x = 0, A = new Map, r = 0; r < b; r++) {
                ...
                if (t.visible()) {
                    ...
                    if (r - x < this.c.left) {
                        ...
                        v = 0;
                        for (w = u; v < w.length; v++) p =
                            w[v], p = a(a(p).children()[r - x]), p.hasClass(this.classes.fixedLeft) && p.css(this._clearCellCSS("left")).removeClass(this.classes.fixedLeft);
            ...
            for (r = b - 1; 0 <= r; r--)
                if (t = this.s.dt.column(r), t.visible())
                    if (y = a(t.header()), t = a(t.footer()), w = A.get(r), void 0 === w && (w = x), r + v >= b - this.c.right) {
                        ...
                        q = 0;
                        for (z = u; q <
                        z.length; q++) p = z[q], p = a(a(p).children()[r - w]), p.hasClass(this.classes.fixedRight) && p.css(this._clearCellCSS("right")).removeClass(this.classes.fixedRight);
            ...
            g && (this.s.rtl ? (this.dom.leftTopBlocker.outerHeight(m), d.append(this.dom.leftTopBlocker)) : (this.dom.rightTopBlocker.outerHeight(m),
                d.append(this.dom.rightTopBlocker)));
        ...
        e.prototype._setKeyTableListener = function() {
            ...
            this.s.dt.on("key-focus", function(g, m, n) {
                ...
                if (0 < d.c.left) {
                    var c = a(d.s.dt.column(d.c.left - 1).header()),
                        b = c.offset(),
                        f = c.outerWidth();
                    g.left < b.left + f && (c = m.scrollLeft(), m.scrollLeft(c - (b.left + f - g.left)))
                }
                0 < d.c.right && (c = d.s.dt.columns().data().toArray().length,
            ...
            this.s.dt.on("column-visibility", function(g, m, n, c, b) {
                b && !m.bDestroying && setTimeout(function() {
                    d._addStyles()
                }, 50)
            })
        };
    ...
    (function(e) {
        ...
        }) : "object" === typeof exports ? module.exports = function(d, g) {
            d || (d = window);
            g && g.fn.dataTable || (g = require("datatables.net")(d,
                g).$);
